...
namespace PharmaSuiteMVC.Controllers
{
    public class MedicineController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            string url = "https://localhost:7259/api/Medicine/Fetch/";
            HttpResponseMessage response = client.GetAsync(url).Result;
            if (response.IsSuccessStatusCode)
            {
                var json = response.Content.ReadAsStringAsync().Result;
        ...
        public IActionResult Add_Medicine()
        {
            ...
            string url = "https://localhost:7259/api/Medicine/FetchCat/";
            HttpResponseMessage response = client.GetAsync(url).Result;
            if (response.IsSuccessStatusCode)
            {
            ...
            string url2 = "https://localhost:7259/api/Medicine/FetchMfg/";
            HttpResponseMessage response2 = client.GetAsync(url2).Result;
            if (response2.IsSuccessStatusCode)
            {
        ...
        public IActionResult fetch_cat()
        {
            List<Category_Dto> cat = new List<Category_Dto>();
            string url = "https://localhost:7259/api/Medicine/FetchCat/";
            HttpResponseMessage response = client.GetAsync(url).Result;
        ...
        {
            string url = "https://localhost:7259/api/Medicine/Add/";
        ...
        public IActionResult Delete_Medicine(int id)
        {
            ...
            string url = "https://localhost:7259/api/Medicine/Delete/";
        ...
        public IActionResult Edit_Medicine(int id)
        {
            ...
            Medicine_Management meds = new Medicine_Management();
            string url3 = "https://localhost:7259/api/Medicine/Edit/";
        ...
        {
            string url = "https://localhost:7259/api/Medicine/PostEdit/";
            var json = JsonConvert.SerializeObject(meds);
            StringContent content = new StringContent(json, Encoding.UTF8, "application/json");
        ...
        {
            string url = "https://localhost:7259/api/Medicine/AddCat/";
        ...
        {
            string url = "https://localhost:7259/api/Medicine/AddMfg/";
